...
final class Simulator
{
    ...
    private function fuelStop(array &$state,string $id,DateTimeImmutable $at):array
    {
        ...
        $crewCopilotTotal=array_sum(array_map(static fn(array $driver):float=>(float)$driver['copilot'],$state['drivers']));$gpm=5+5*min(90,$crewCopilotTotal)/90;$seconds=(int)round(60+$needed/$gpm*60);$state['vehicle']['fuel']=$state['vehicle']['capacity'];$state['vehicle']['stopped_seconds']+=$seconds;$state['fuel_warning']=false;
